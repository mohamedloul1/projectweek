...
public class PlayerController : MonoBehaviour {
    ...
    private bool creat_Node_At_Tail;
    ...
    void Move() {
        ...
        for (int i = 1; i < nodes.Count; i++) {
            ...
            parenPos = prevPosition;
        }

        // check if we need to creat a new node
        // because we ate a fruit 
        // if(creat_Node_At_Tail) {

        //     creat_Node_At_Tail = false;
